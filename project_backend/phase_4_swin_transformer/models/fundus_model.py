"""
Fundus Dedicated Swin Transformer Model Wrapper.
"""
...
class FundusSwinModel(nn.Module):
    """
    Dedicated Swin Transformer model for Color Retinal Fundus Photography.
    """
